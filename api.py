...
path = 'https://raw.githubusercontent.com/mankarali/mankarali07api/master/credit_test_sample_data.csv'
path2 = 'https://raw.githubusercontent.com/mankarali/mankarali07api/master/credit_test_sample_data_normalise.csv'
...
def home():
    return "<h1>Notre mission:</h1><h2> * Élaborer un modèle de scoring sur la probabilité de défaut de paiement d'un client et l'implémenter \
    via une API.</h2><p> * Construire un tableau de bord interactif pour les chargés de relation client afin d'interpréter le résultat \
    du modèle, d'améliorer leur connaissance client et de proposer aux clients la consultation de leurs données personnelles.</p>"
